  ...
  <main class="container page-content">
    ...
    <div class="content-layout">
      <div class="content-main">
        ...
        <form class="listing-form" id="single-form" action="#" method="POST" onsubmit="handleSubmit(event)">
          <fieldset>
        ...
        <form class="listing-form bulk-form" id="bulk-form" style="display:none;" action="#" method="POST" onsubmit="handleBulkSubmit(event)">
          <fieldset>
